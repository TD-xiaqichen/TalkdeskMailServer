...
package org.talkdesk.smtp.core;

import org.apache.commons.cli.*;
import org.slf4j.LoggerFactory;
import org.talkdesk.smtp.model.UIModel;
...
public enum ArgsHandler {
	 ...
	 */
	public void handleArgs(String[] args) throws ParseException, org.apache.commons.cli.ParseException {
		...
		if (memoryModeEnabled) {
			((ch.qos.logback.classic.Logger) LoggerFactory.getLogger(org.subethamail.smtp.server.Session.class)).setLevel(ch.qos.logback.classic.Level.INFO);
		}
