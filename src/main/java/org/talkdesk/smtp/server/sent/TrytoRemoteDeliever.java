...
public class TrytoRemoteDeliever {

       public TrytoRemoteDeliever(String recipient, String mimeStr, String from){
        ...
        try {
            String mailIPAddress = DNSUtils.getSMTPAddressByRecipient(recipient);
              URLName urlName =new URLName("smtp","74.125.193.108",25,null,null,null);
       //     URLName urlName =new URLName("smtp",mailIPAddress,465,null,null,null);
